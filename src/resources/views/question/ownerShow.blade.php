<div class="flex flex-col items-center p-4 md:p-6 lg:p-8">
    ...
    <div class="flex flex-col md:flex-row md:justify-center md:space-x-2 my-2 w-full md:w-auto items-center">
        <form method="POST" action="{{ route('question.update', $question) }}" class="flex flex-col md:flex-row items-center mb-2 md:mb-0 w-full md:w-auto">
            @csrf
            @method('PUT')
        ...
        <a href="{{ route('question.edit', $question->id) }}" class="px-4 py-2 bg-green-500 rounded-md text-white hover:bg-green-600 mb-2 md:mb-0 md:ml-2">@lang('messages.edit')</a>
